...
public abstract class EmbeddedIdGenerator implements IdentifierGenerator {
    ...
    public Serializable generate(SharedSessionContractImplementor session, Object obj) throws HibernateException {
        return switch (type) {
            case "SEQUENCE" -> getIdFromSequenceGenerator(session);
            default -> atomicLong.getAndIncrement();
        };
    }

    private Long getIdFromSequenceGenerator(SharedSessionContractImplementor session) {
